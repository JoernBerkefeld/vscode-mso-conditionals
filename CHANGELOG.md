...
- Setting `msoConditionals.diagnostics.enable` (default: `true`) — disable extension diagnostics when using [`eslint-plugin-mso-conditionals`](https://www.npmjs.com/package/eslint-plugin-mso-conditionals) instead
