...
|---|---|---|---|
| `msoConditionals.diagnostics.enable` | boolean | `true` | Show inline errors and warnings. Disable if you prefer diagnostics from [`eslint-plugin-mso-email`](https://www.npmjs.com/package/eslint-plugin-mso-email) instead. |
